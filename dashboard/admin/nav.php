...
<ul id="main-menu" class="" >
	...
	<li id=""><a href="trainer.php"><i class="entypo-users"></i><span>Trainer</span></a></li>

	<li class="" id="overviewhassubopen"><a href="#" onclick="memberExpand(3)"><i class="entypo-box"></i><span>Report</span></a>
